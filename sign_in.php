    ...
    <div class="front-form">
        <div class="layout">
            ...
            <form method="post" action="./sign_in.php">
                ...
                <input name="username" id="username" type="text" maxlength="30" spellcheck="false"
                    pattern="^[a-zA-Z0-9!#%?*_]+$" required="required" autofocus="autofocus"
                    value="<?php echo $inputValues['username']; ?>">
                ...
                <div class="label-info">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Max. 72 characters</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <input name="password" id="password" type="password" maxlength="72" autocomplete="off"
                    required="required">
